...
/**
 * <p>
 * Dao which performs operations on Review database according to URL mapping
 * </p>
 * 
 * @author Team #3
 * 
...
public class ReviewDao {
    ...
    /**
     * <p>
     * Method which fetches request from service. Insert review details into
     * database.
     * </p>
     * 
     * @param review
    ...
    public void insertReview(Review review, int advertisementId, int userId) throws VillaPursuitException {
        ...
        try {
            ...
            throw new VillaPursuitException(
                    "\t\"Error occured while Adding Review... Please try again...\"" + exceptionCause.toString());
        } finally {
            session.close();
        }
    }
    ...
    public List<Review> retriveAllReviews() throws VillaPursuitException {
        ...
        try {
            ...
            throw new VillaPursuitException(
                    "\t\"Error occured while retriving Reviews... Please try again...\"" + exceptionCause.toString());
        } finally {
            session.close();
        }
    }
