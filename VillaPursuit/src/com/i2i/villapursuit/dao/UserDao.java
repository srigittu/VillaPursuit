...
/**
 * <p>
 * Dao which performs operations on user database according to URL mapping
 * </p>
 * 
 * @author Team #3
 * 
...
public class UserDao {
    ...
    public void insertUser(User user) throws VillaPursuitException {
        ...
        try {
            ...
            throw new VillaPursuitException(
                    "\t\"Error occured while Adding User... Please try again...\"" + exceptionCause.toString());
        } finally {
            session.close();
        }
    }
    ...
    /**
     * <p>
     * Method which fetches request from service. Retrieve all user details from
     * database.
     * </p>
     * 
     * @return users 
    ...
    public List<User> retriveAllUsers() throws VillaPursuitException {
        ...
        try {
            transaction = session.beginTransaction();
            List<User> users = session.createQuery("FROM User").list(); // Getting
                                                                        // Users
            transaction.commit();
            return users;
        } catch (HibernateException exceptionCause) {
            ...
            throw new VillaPursuitException(
                    "\t\"Error occured while retriving Users... Please try again...\"" + exceptionCause.toString());
        } finally {
            session.close();
        }
    }
    ...
    /**
     * <p>
     * Method which gets request from service. Get user by user name from
     * database.
     * </p>
     * 
     * @param userName
     ...
     *             If there is failed or interrupted database operations.
     */
    public void deleteUser(int userId) throws VillaPursuitException {
        Session session = sessionFactory.openSession();
        try {
            transaction = session.beginTransaction();
            ...
            throw new VillaPursuitException(
                    "\t\"Error occured while removing User... Please try again...\"" + exceptionCause.toString());
        } finally {
            session.close();
        }
    }
    ...
    /**
     * <p>
     * Method which gets request from service. Update password to the user
     * database.
     * </p>
     * 
     * @param userName
    ...
    /**
     * <p>
     * Method which gets request from service. Insert address to the address
     * database. Update address Id to the user database.
     * </p>
     * 
     * @param address
    ...
    public void insertUserAddress(Address address, int userId) throws VillaPursuitException {
        ...
        try {
            ...
            throw new VillaPursuitException(
                    "\t\"Error occured while Adding Address... Please try again...\"" + exceptionCause.toString());
        } finally {
            session.close();
        }
    }
