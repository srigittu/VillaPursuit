...
/**
 * <p>
 * Service which gets request from controller. Permits to perform user
 * registration and address insertion operations. According to URL mapping
 * </p>
 * 
 * @author Team #3
 *
...
public class UserService {
    ...
    /**
     * <p>
     * Method which gets request from controller. Perform validations to remove
     ...
     *             If there is failed or interrupted database operations.
     */
    public void removeUser(int userId) throws VillaPursuitException {
        userDao.deleteUser(userId);
    }

    /**
     * <p>
     * Method which gets request from controller. Perform validations to get
     * user details from database.
     * </p>
     * 
     * @param userName
     *            Contains name of the user.
     * @return user 
     *             Returns particular user detail.
     * @throws VillaPursuitException
     *             If there is failed or interrupted database operations.
     */
     ...
     * <p>
     * Method which gets request from controller. Perform validations to get
     * list of user details from database.
     * </p>
     * 
     * @return List<User> 
     ...
     * <p>
     * Method which gets request from controller. Perform validations to insert
     * address details into database.
     * </p>
     * 
     * @param userAddress
     *            Object contains user address details to be inserted into
     *            database.
     * @param userId
