    ...
    <c:if test="${advertisements.size() != 0}">
        <div class="location">
            ...
            <form action="filter_search">
                ...
                <br> <label>Price (10k-40k):</label><br> <span
                    id="slider_value" style="color: white; text-align: right;"></span>
                <br>
                <script>
                ...
                <input type="range" min="10000" max="40000" name="price"
                    value="10000" onchange="show_value(this.value);"> <br>
                        ...
                        <td style="padding: 1px; text-align: right;">
                            <form action="reviewForm">
                                <input type="hidden" value="${advertisement.getId()}"
                                    name="advertisementId"> <input type="submit"
                                    value="Add Review">
                            </form>
                        </td>
            ...
            <table>
                ...
                <tr>
                    <td><c:forEach var="image"
                            ...
                            <img src="upload/<c:out value="${image.getImagePath()}"/>"
    ...
    <c:if test="${viewSellerAdvertisement != null}">
        <div class="ad">
            <table>
                <tr>
                    <td><c:forEach var="image"
                            items="${viewSellerAdvertisement.getImages()}">
                            <img src="upload/<c:out value="${image.getImagePath()}"/>"
                                width="150px" height="75px" />
                            <br></br>
                        </c:forEach></td>
                    <td>
                        ...
                        <div class="title" style="margin-top: 10px; padding: 2px;">
                            <c:out value="${'House Type :'}" />
                            <span><c:out
                                    value="${viewSellerAdvertisement.getHouseType()}" /></span>
                        </div>
                        <div class="title" style="padding: 2px;">
                            <c:out value="${'Rent Type :'}" />
                            <span><c:out
                                    value="${viewSellerAdvertisement.getRentType()}" /></span>
                        </div> <c:set value="${viewSellerAdvertisement.getFacility()}"
                            var="facility" />
                        <div class="title" style="padding: 2px;">
                            <c:out value="${'Bed Rooms :'}" />
                            <span><c:out value="${facility.getBedroom()}" /></span>
                    ...
                    <td style="padding: 10px;">
                        <div class="title" style="padding: 2px;">
                            <c:out value="${'₹ : '}" />
                            <span><c:out value="${viewSellerAdvertisement.getPrice()}" /></span>/Month
                        </div>
                    </td>
                    <td style="padding: 10px;">
                        <div class="title" style="margin-top: 10px; padding: 2px;">
                            <c:out value="${'Availability :'}" />
                            <span><c:out
                                    value="${viewSellerAdvertisement.getAvailability()}" /></span>
                        </div>
                    </td>
                    <td>
                        <div class="title" style="margin-top: 10px; padding: 2px;">
                            <c:out value="${'Posted On :'}" />
                            <br> <span><c:out
                                    value="${viewSellerAdvertisement.getDate()}" /></span>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3"><c:set
                            value="${viewSellerAdvertisement.getAddress()}" var="address" />
                        <div class="title" style="padding: 2px;">
                            <c:out value="${'No: '}" />
                            <span><c:out value="${address.getNumber()}" />, <c:out
                                    value="${address.getStreet()}" />,<br> <c:out
                                    value="${address.getCity()}" />, <c:out
                                    value="${address.getState()}" />, <c:out
                                    value="${address.getPincode()}" />.</span>
                        </div></td>
                    <td colspan="2"><c:set
                            value="${viewSellerAdvertisement.getUser()}" var="seller" />
                        <div class="title">
                ...
                <c:if
                    test="${viewSellerAdvertisement.getAdvertisementReviews().size() == 0}">
                    <tr style="border-bottom: 3px solid white">
                        <td colspan="5">
                ...
                <c:forEach var="review"
                    items="${viewSellerAdvertisement.getAdvertisementReviews()}">
                    <tr style="border-bottom: 3px solid white">
