...
<body>
    ...
    <br>
                ...
                <table>
                    <c:forEach var="advertisement" items="${advertisements}">
                             ...
                             <td>
                                ...
                                <span><c:out value="${facility.getAreaSize()}"/></span></div>
        ...
        <c:if test="${reviewAdvertisement != null}">
            ...
            <div class="seller">
            <form action="seller">
                <input type="submit" value="My Post">
            </form>
            </div>
            </c:if>
        ...
        <div class="home">
         ...
         <c:if test="${viewAdvertisement != null}">
            <div class="ad">
                <table>
                        <tr>
                             <td>
