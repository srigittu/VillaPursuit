...
<body>
	...
	<div class="message">
		<div>
			Enter<span>Villa</span>Details
		</div>
	</div>
	<div class="col-sm-7"
		style="position: absolute; top: calc(32% - 35px); left: calc(42% - 255px); z-index: 3; background-color: #000; opacity: 0.8;">

		<form:form commandName="advertisementForm" method="post"
			action="addAdvertisement" id="signupForm"
			...
			<div class="form-group" style="padding: 10px;">
				...
				<form:input cssClass="form-control" path="title"
					style="font-size: 32px; height: 100px;" />
				<form:errors path="title"></form:errors>
			</div>
			<div class="form-group" style="padding: 10px;">
				<label styleClass="control-label" style="font-size: 18px;">Upload
					Image</label> <input type="file" name="file" id="file" />
			</div>
			...
			<div class="row" style="padding: 10px;">
				<div class="col-sm-6 form-group">
					...
					<form:input cssClass="form-control" path="availability"
						placeholder="Availability" />
					<form:errors path="availability"></form:errors>
					<div class="row"
						style="background: #000; opacity: 0.6; height: 10px;"></div>
					<form:input cssClass="form-control" path="price"
						placeholder="Price" />
					<form:errors path="price"></form:errors>
				</div>
				<div class="col-sm-6 form-group">
					<form:select cssClass="form-control" path="houseType"
					...
					<form:select cssClass="form-control" path="rentType"
						style="width: 200px; float:right;">
			...
			<div class="row"
				style="background: #000; opacity: 0.6; height: 20px;"></div>
			...
			<div class="row" style="padding: 10px;">
				<div class="col-sm-6 form-group">
					...
					<div class="row"
						style="background: #000; opacity: 0.6; height: 10px;"></div>
					<form:input cssClass="form-control" path="facility.areaSize"
						placeholder="Area Size" />
					<br>
					<form:errors path="facility.areaSize"></form:errors>
				</div>
				<div class="col-sm-6 form-group" style="font-size: 20px;">
					<form:checkbox path="facility.parking" />
					Parking &nbsp;
					<form:checkbox path="facility.drainage" />
					Drainage &nbsp;
					<form:checkbox path="facility.transport" />
					Transport
				</div>
			</div>
			<div class="row"
				style="background: #000; opacity: 0.6; height: 20px;"></div>
			<label styleClass="control-label" style="font-size: 24px;">Address
				Details</label>
			<div class="form-group" style="padding: 10px;">
				<form:input cssClass="form-control" path="address.address"
					id="address.address" placeholder="No/Street" />
			</div>
			<div class="row" style="padding: 10px;">
				<div class="col-sm-6 form-group">
					<form:input cssClass="form-control" path="address.area"
						id="address.area" placeholder="Area" />
					<div class="row"
						style="background: #000; opacity: 0.6; height: 10px;"></div>
				...
				<div class="col-sm-6 form-group">
					<form:input cssClass="form-control" path="address.state"
						id="address.state" placeholder="State" />
					<div class="row"
						style="background: #000; opacity: 0.6; height: 10px;"></div>
					<form:input cssClass="form-control" path="address.pincode"
						id="address.pincode" placeholder="Pincode" />
				</div>
				<div class="col-sm-6 form-group">
					<form:input cssClass="form-control" path="address.landMark"
						id="address.landMark" placeholder="Landmark" />
				</div>
			</div>
